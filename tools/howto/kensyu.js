...
const PHASES = [
  ...
  { from:5, to:12, name:'第2期　N4を仕上げる', min:'1日30分',
    ...
    task:['文型 N4　平日1日3項目（週15項目）　※117項目を8週で',
          '漢字 N4　平日1日4字（週18字）　※144字を8週で',
          '語彙 N4　平日1日17語（週83語）　※662語を8週で',
...
const STAFF = {
  1:'診断テスト 第1回（筆記50分＋聴解15分＋口頭5分）。結果から1月以降を調整する',
  4:'月末面談30分：12月をふりかえる。生活の困りごとも聞く',
  8:'月末面談30分：N4の進みを確認。おくれていれば量を減らす',
  12:'月末面談30分：N4が仕上がったか確認。文型の「覚えた」数を見る',
...
<h2>2　1日の使い方（目安）</h2>
<table><thead><tr><th>期</th><th>時間</th><th>いつ</th><th>中身</th></tr></thead><tbody>
<tr><td>第1期</td><td>15分</td><td>夜、寝る前</td><td>漢字5字＋語彙10語。聴解は週3回だけ</td></tr>
<tr><td>第2期</td><td>30分</td><td>朝15分＋夜15分</td><td>朝＝文型3項目／夜＝漢字4字＋語彙17語。読解と聴解は休みの日</td></tr>
<tr><td>第3期</td><td>50分</td><td>朝20分＋夜30分</td><td>朝＝文型2項目＋語彙11語／夜＝漢字4字＋読解1本（週1）</td></tr>
<tr><td>第4期</td><td>60分</td><td>朝20分＋夜40分</td><td>朝＝漢字4字＋語彙11語／夜＝100日コースの日課。土曜だけ50分続けて取る</td></tr>
</tbody></table>
<div class="tip"><b>朝と夜に分けるのがこつです。</b>まとめて1時間は続きません。
早出のある週は「帰ってから」に寄せて、量は半分でかまいません。<b>0にしないこと</b>が大事です。</div>
...
<tr><td>第1週・第16週</td><td>診断テスト（第1回・第2回）</td><td>90分</td></tr>
