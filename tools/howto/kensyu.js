...
const STAFF = {
  1:'<b>N4到達度判定テスト（60分・66問）</b>＋診断テスト第1回。入職時点のN4を判定し、部ごとの正答率から12月からの量を決める',
...
<tr><td>第1週</td><td><b>N4到達度判定テスト</b>（60分）＋診断テスト第1回（70分）。<b>来日直後なので、2日に分けてよい</b>（例：判定テストを1日目、診断テストを2日目）。両方やるのは、判定テストが「N4がどれだけあるか」を線を引いて見るもの、診断テストが「書く・話す」を含めて様子を見るもので、見るところが違うため</td><td>合計130分</td></tr>
<tr><td>第16週</td><td>診断テスト 第2回（第1回と同じ形）</td><td>90分</td></tr>
