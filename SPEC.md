...
| 収録熟語 | 3,053語（N5 555・N4 537・N3 1,836・**現場用語 125**） |
...
| 機能 | 仕様 |
|---|---|
| 収録 | JLPT N5–N3 語彙 2,928語 ＋ **現場用語 125語**（合計3,053語） |
| 現場用語の分野 | 安全（33語）／作業／設備・工具／品質・管理／健康・けが／生活・手続き |
...
| `vocab.json` | 約410 KB | 熟語3,053語（JLPT＋現場用語） | 最新 |
...
| 画面動作 | Chromium実機での自動テスト43項目（合言葉ゲート・漢字表示・熟語表示・検索・絞り込み・アニメーション・言語切替・漢字↔熟語の相互移動・記録保存・スマホ表示・JSエラー） | 全項目合格 |
