...
| 項目 | 仕様 |
|---|---|
| 構成 | 週単位（現在**第6週**まで・設問522問）。各週に月〜日の日課。1日＝読解本文＋設問＋その本文から拾う語彙10語＋文法2項目＋確認ドリル6問 |
| 週の型 | 月＝短文（掲示・案内）／火＝短文（メール）／水＝中文（エッセイ）／木＝中文（意見文）／金＝情報検索／土＝読解通しテスト（第5週以降55分）／日＝聴解7問＋今週の復習20問 |
