...
| 絞り込み | レベル（N5/N4/N3/現場）× 分野 |
| 熟語をタップ | 意味（ID＋EN）と**構成漢字のカード**を表示。漢字をタップすると書き順アニメへ |
| 漢字詳細から | 「この字を使う熟語」を最大12語表示。タップで熟語画面へ |
...
**CSVの列**：`熟語, ふりがな, 意味（インドネシア語）, 分野, 意味（英語）, 削除`
...
| 画面動作 | Chromium実機での自動テスト48項目（合言葉ゲート・漢字表示・熟語表示・検索・絞り込み・アニメーション・言語切替・漢字↔熟語の相互移動・記録保存・スマホ表示・JSエラー） | 全項目合格 |
