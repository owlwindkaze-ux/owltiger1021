...
| メニュー | 漢字側6項目（漢字一覧・熟語・フラッシュカード・練習問題・書き順・学習状況）／文型側3項目／読解側3項目（文章一覧・読む・学習状況）／聴解側3項目（申し送り・職員どうしの会話・利用者さんの言葉）の計15項目。押すと該当タブ・該当パートが直接ひらく |
...
| 合言葉 | 保存キー・保存値をアプリ側と統一しているため、**入口で一度入れれば4システムとも開く** |
