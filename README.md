...
| `shinjin/index.html` | **新人コースの入り口**（N4で入った職員が7月のN3に合格するまでの道すじ。今月やること・今日ひらくもの） |
| `shindan/index.html` | **診断テストの聴解を再生する職員用ページ** |
| `診断テスト_第1回_問題.pdf` | N4診断テスト 第1回（入職直後）の問題冊子 |
| `診断テスト_第2回_問題.pdf` | N4診断テスト 第2回（3か月後）の問題冊子 |
| `診断テスト_実施と採点.pdf` | 実施の手引き・採点・判定・口頭チェックシート・聴解スクリプト・正解一覧 |
